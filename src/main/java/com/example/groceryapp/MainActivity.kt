...
class MainActivity : AppCompatActivity() , GroceryRVAdapter.GroceryItemClickInterface{
    ...
    lateinit var groceryViewModel: GroceryViewModel // access the data from view model
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // get items present in the database with the help of groceryViewModel
        // call observe as we are using live data
        // notify the change
